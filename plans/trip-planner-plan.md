...
| 8 | Table naming | **`saved_places`** (not `places`) | ⚑ flagged call. Avoids collision with the NPS `places` API asset (importer coordinate join) and Overture "Places" language in the POI plan. |
