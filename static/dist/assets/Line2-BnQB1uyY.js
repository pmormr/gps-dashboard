...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
		...
		`};var Ls=class extends nr{constructor(e){super({type:`LineMaterial`,uniforms:$n.clone(br.line.uniforms),vertexShader:br.line.vertexShader,fragmentShader:br.line.fragmentShader,clipping:!0}),this.isLineMaterial=!0,this.setValues(e)}get color(){return this.uniforms.diffuse.value}set color(e){this.uniforms.diffuse.value=e}get worldUnits(){return`WORLD_UNITS`in this.defines}set worldUnits(e){e===!0?this.defines.WORLD_UNITS=``:delete this.defines.WORLD_UNITS}get linewidth(){return this.uniforms.linewidth.value}set linewidth(e){this.uniforms.linewidth&&(this.uniforms.linewidth.value=e)}get dashed(){return`USE_DASH`in this.defines}set dashed(e){e===!0!==this.dashed&&(this.needsUpdate=!0),e===!0?this.defines.USE_DASH=``:delete this.defines.USE_DASH}get dashScale(){return this.uniforms.dashScale.value}set dashScale(e){this.uniforms.dashScale.value=e}get dashSize(){return this.uniforms.dashSize.value}set dashSize(e){this.uniforms.dashSize.value=e}get dashOffset(){return this.uniforms.dashOffset.value}set dashOffset(e){this.uniforms.dashOffset.value=e}get gapSize(){return this.uniforms.gapSize.value}set gapSize(e){this.uniforms.gapSize.value=e}get opacity(){return this.uniforms.opacity.value}set opacity(e){this.uniforms&&(this.uniforms.opacity.value=e)}get resolution(){return this.uniforms.resolution.value}set resolution(e){this.uniforms.resolution.value.copy(e)}get alphaToCoverage(){return`USE_ALPHA_TO_COVERAGE`in this.defines}set alphaToCoverage(e){this.defines&&(e===!0!==this.alphaToCoverage&&(this.needsUpdate=!0),e===!0?(this.defines.USE_ALPHA_TO_COVERAGE=``,this.extensions.derivatives=!0):(delete this.defines.USE_ALPHA_TO_COVERAGE,this.extensions.derivatives=!1))}},Rs=new X,zs=new X,Bs=new Be,Vs=new Be,Hs=new Be,Us=new X,Ws=new xt,Gs=new Ns,Ks=new X,qs=new Je,Js=new ft,Ys=new Be,Xs,Zs;function Qs(e,t,n){return Ys.set(0,0,-t,1).applyMatrix4(e.projectionMatrix),Ys.multiplyScalar(1/Ys.w),Ys.x=Zs/n.width,Ys.y=Zs/n.height,Ys.applyMatrix4(e.projectionMatrixInverse),Ys.multiplyScalar(1/Ys.w),Math.abs(Math.max(Ys.x,Ys.y))}function $s(e,t){let n=e.matrixWorld,r=e.geometry,i=r.attributes.instanceStart,a=r.attributes.instanceEnd,o=Math.min(r.instanceCount,i.count);for(let r=0,s=o;r<s;r++){Gs.start.fromBufferAttribute(i,r),Gs.end.fromBufferAttribute(a,r),Gs.applyMatrix4(n);let o=new X,s=new X;Xs.distanceSqToSegment(Gs.start,Gs.end,s,o),s.distanceTo(o)<Zs*.5&&t.push({point:s,pointOnLine:o,distance:Xs.origin.distanceTo(s),object:e,face:null,faceIndex:r,uv:null,uv1:null})}}function ec(e,t,n){let r=t.projectionMatrix,i=e.material.resolution,a=e.matrixWorld,o=e.geometry,s=o.attributes.instanceStart,c=o.attributes.instanceEnd,l=Math.min(o.instanceCount,s.count),u=-t.near;Xs.at(1,Hs),Hs.w=1,Hs.applyMatrix4(t.matrixWorldInverse),Hs.applyMatrix4(r),Hs.multiplyScalar(1/Hs.w),Hs.x*=i.x/2,Hs.y*=i.y/2,Hs.z=0,Us.copy(Hs),Ws.multiplyMatrices(t.matrixWorldInverse,a);for(let t=0,o=l;t<o;t++){if(Bs.fromBufferAttribute(s,t),Vs.fromBufferAttribute(c,t),Bs.w=1,Vs.w=1,Bs.applyMatrix4(Ws),Vs.applyMatrix4(Ws),Bs.z>u&&Vs.z>u)continue;if(Bs.z>u){let e=Bs.z-Vs.z,t=(Bs.z-u)/e;Bs.lerp(Vs,t)}else if(Vs.z>u){let e=Vs.z-Bs.z,t=(Vs.z-u)/e;Vs.lerp(Bs,t)}Bs.applyMatrix4(r),Vs.applyMatrix4(r),Bs.multiplyScalar(1/Bs.w),Vs.multiplyScalar(1/Vs.w),Bs.x*=i.x/2,Bs.y*=i.y/2,Vs.x*=i.x/2,Vs.y*=i.y/2,Gs.start.copy(Bs),Gs.start.z=0,Gs.end.copy(Vs),Gs.end.z=0;let o=Gs.closestPointToPointParameter(Us,!0);Gs.at(o,Ks);let l=be.lerp(Bs.z,Vs.z,o),d=l>=-1&&l<=1,f=Us.distanceTo(Ks)<Zs*.5;if(d&&f){Gs.start.fromBufferAttribute(s,t),Gs.end.fromBufferAttribute(c,t),Gs.start.applyMatrix4(a),Gs.end.applyMatrix4(a);let r=new X,i=new X;Xs.distanceSqToSegment(Gs.start,Gs.end,i,r),n.push({point:i,pointOnLine:r,distance:Xs.origin.distanceTo(i),object:e,face:null,faceIndex:t,uv:null,uv1:null})}}}var tc=class extends Gn{constructor(e=new Is,t=new Ls({color:Math.random()*16777215})){super(e,t),this.isLineSegments2=!0,this.type=`LineSegments2`}computeLineDistances(){let e=this.geometry,t=e.attributes.instanceStart,n=e.attributes.instanceEnd,r=new Float32Array(2*t.count);for(let e=0,i=0,a=t.count;e<a;e++,i+=2)Rs.fromBufferAttribute(t,e),zs.fromBufferAttribute(n,e),r[i]=i===0?0:r[i-1],r[i+1]=r[i]+Rs.distanceTo(zs);let i=new ks(r,2,1);return e.setAttribute(`instanceDistanceStart`,new Co(i,1,0)),e.setAttribute(`instanceDistanceEnd`,new Co(i,1,1)),this}raycast(e,t){let n=this.material.worldUnits,r=e.camera;r===null&&!n&&console.error(`LineSegments2: "Raycaster.camera" needs to be set in order to raycast against LineSegments2 while worldUnits is set to false.`);let i=e.params.Line2===void 0?0:e.params.Line2.threshold||0;Xs=e.ray;let a=this.matrixWorld,o=this.geometry,s=this.material;Zs=s.linewidth+i,o.boundingSphere===null&&o.computeBoundingSphere(),Js.copy(o.boundingSphere).applyMatrix4(a);let c;if(c=n?Zs*.5:Qs(r,Math.max(r.near,Js.distanceToPoint(Xs.origin)),s.resolution),Js.radius+=c,Xs.intersectsSphere(Js)===!1)return;o.boundingBox===null&&o.computeBoundingBox(),qs.copy(o.boundingBox).applyMatrix4(a);let l;l=n?Zs*.5:Qs(r,Math.max(r.near,qs.distanceToPoint(Xs.origin)),s.resolution),qs.expandByScalar(l),Xs.intersectsBox(qs)!==!1&&(n?$s(this,t):ec(this,r,t))}},nc=class extends Is{constructor(){super(),this.isLineGeometry=!0,this.type=`LineGeometry`}setPositions(e){let t=e.length-3,n=new Float32Array(2*t);for(let r=0;r<t;r+=3)n[2*r]=e[r],n[2*r+1]=e[r+1],n[2*r+2]=e[r+2],n[2*r+3]=e[r+3],n[2*r+4]=e[r+4],n[2*r+5]=e[r+5];return super.setPositions(n),this}setColors(e){let t=e.length-3,n=new Float32Array(2*t);for(let r=0;r<t;r+=3)n[2*r]=e[r],n[2*r+1]=e[r+1],n[2*r+2]=e[r+2],n[2*r+3]=e[r+3],n[2*r+4]=e[r+4],n[2*r+5]=e[r+5];return super.setColors(n),this}fromLine(e){let t=e.geometry;return this.setPositions(t.attributes.position.array),this}},rc=class extends tc{constructor(e=new nc,t=new Ls({color:Math.random()*16777215})){super(e,t),this.isLine2=!0,this.type=`Line2`}};export{As as A,Mo as C,k as D,n as E,vo as F,ss as M,q as N,bo as O,X as P,Lo as S,bt as T,Gn as _,gn as a,ir as b,Z as c,fo as d,Ao as f,be as g,e as h,hs as i,t as j,zo as k,ms as l,jo as m,nc as n,Dn as o,wo as p,Ls as r,rr as s,rc as t,re as u,pn as v,Ge as w,pr as x,Ho as y};