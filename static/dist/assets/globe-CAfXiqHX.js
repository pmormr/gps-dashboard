...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
		...
		`};var Ws=class extends nr{constructor(e){super({type:`LineMaterial`,uniforms:$n.clone(br.line.uniforms),vertexShader:br.line.vertexShader,fragmentShader:br.line.fragmentShader,clipping:!0}),this.isLineMaterial=!0,this.setValues(e)}get color(){return this.uniforms.diffuse.value}set color(e){this.uniforms.diffuse.value=e}get worldUnits(){return`WORLD_UNITS`in this.defines}set worldUnits(e){e===!0?this.defines.WORLD_UNITS=``:delete this.defines.WORLD_UNITS}get linewidth(){return this.uniforms.linewidth.value}set linewidth(e){this.uniforms.linewidth&&(this.uniforms.linewidth.value=e)}get dashed(){return`USE_DASH`in this.defines}set dashed(e){e===!0!==this.dashed&&(this.needsUpdate=!0),e===!0?this.defines.USE_DASH=``:delete this.defines.USE_DASH}get dashScale(){return this.uniforms.dashScale.value}set dashScale(e){this.uniforms.dashScale.value=e}get dashSize(){return this.uniforms.dashSize.value}set dashSize(e){this.uniforms.dashSize.value=e}get dashOffset(){return this.uniforms.dashOffset.value}set dashOffset(e){this.uniforms.dashOffset.value=e}get gapSize(){return this.uniforms.gapSize.value}set gapSize(e){this.uniforms.gapSize.value=e}get opacity(){return this.uniforms.opacity.value}set opacity(e){this.uniforms&&(this.uniforms.opacity.value=e)}get resolution(){return this.uniforms.resolution.value}set resolution(e){this.uniforms.resolution.value.copy(e)}get alphaToCoverage(){return`USE_ALPHA_TO_COVERAGE`in this.defines}set alphaToCoverage(e){this.defines&&(e===!0!==this.alphaToCoverage&&(this.needsUpdate=!0),e===!0?(this.defines.USE_ALPHA_TO_COVERAGE=``,this.extensions.derivatives=!0):(delete this.defines.USE_ALPHA_TO_COVERAGE,this.extensions.derivatives=!1))}},Gs=new X,Ks=new X,qs=new Be,Js=new Be,Ys=new Be,Xs=new X,Zs=new xt,Qs=new Ns,$s=new X,ec=new Je,tc=new ft,nc=new Be,rc,ic;function ac(e,t,n){return nc.set(0,0,-t,1).applyMatrix4(e.projectionMatrix),nc.multiplyScalar(1/nc.w),nc.x=ic/n.width,nc.y=ic/n.height,nc.applyMatrix4(e.projectionMatrixInverse),nc.multiplyScalar(1/nc.w),Math.abs(Math.max(nc.x,nc.y))}function oc(e,t){let n=e.matrixWorld,r=e.geometry,i=r.attributes.instanceStart,a=r.attributes.instanceEnd,o=Math.min(r.instanceCount,i.count);for(let r=0,s=o;r<s;r++){Qs.start.fromBufferAttribute(i,r),Qs.end.fromBufferAttribute(a,r),Qs.applyMatrix4(n);let o=new X,s=new X;rc.distanceSqToSegment(Qs.start,Qs.end,s,o),s.distanceTo(o)<ic*.5&&t.push({point:s,pointOnLine:o,distance:rc.origin.distanceTo(s),object:e,face:null,faceIndex:r,uv:null,uv1:null})}}function sc(e,t,n){let r=t.projectionMatrix,i=e.material.resolution,a=e.matrixWorld,o=e.geometry,s=o.attributes.instanceStart,c=o.attributes.instanceEnd,l=Math.min(o.instanceCount,s.count),u=-t.near;rc.at(1,Ys),Ys.w=1,Ys.applyMatrix4(t.matrixWorldInverse),Ys.applyMatrix4(r),Ys.multiplyScalar(1/Ys.w),Ys.x*=i.x/2,Ys.y*=i.y/2,Ys.z=0,Xs.copy(Ys),Zs.multiplyMatrices(t.matrixWorldInverse,a);for(let t=0,o=l;t<o;t++){if(qs.fromBufferAttribute(s,t),Js.fromBufferAttribute(c,t),qs.w=1,Js.w=1,qs.applyMatrix4(Zs),Js.applyMatrix4(Zs),qs.z>u&&Js.z>u)continue;if(qs.z>u){let e=qs.z-Js.z,t=(qs.z-u)/e;qs.lerp(Js,t)}else if(Js.z>u){let e=Js.z-qs.z,t=(Js.z-u)/e;Js.lerp(qs,t)}qs.applyMatrix4(r),Js.applyMatrix4(r),qs.multiplyScalar(1/qs.w),Js.multiplyScalar(1/Js.w),qs.x*=i.x/2,qs.y*=i.y/2,Js.x*=i.x/2,Js.y*=i.y/2,Qs.start.copy(qs),Qs.start.z=0,Qs.end.copy(Js),Qs.end.z=0;let o=Qs.closestPointToPointParameter(Xs,!0);Qs.at(o,$s);let l=be.lerp(qs.z,Js.z,o),d=l>=-1&&l<=1,f=Xs.distanceTo($s)<ic*.5;if(d&&f){Qs.start.fromBufferAttribute(s,t),Qs.end.fromBufferAttribute(c,t),Qs.start.applyMatrix4(a),Qs.end.applyMatrix4(a);let r=new X,i=new X;rc.distanceSqToSegment(Qs.start,Qs.end,i,r),n.push({point:i,pointOnLine:r,distance:rc.origin.distanceTo(i),object:e,face:null,faceIndex:t,uv:null,uv1:null})}}}var cc=class extends Gn{constructor(e=new Us,t=new Ws({color:Math.random()*16777215})){super(e,t),this.isLineSegments2=!0,this.type=`LineSegments2`}computeLineDistances(){let e=this.geometry,t=e.attributes.instanceStart,n=e.attributes.instanceEnd,r=new Float32Array(2*t.count);for(let e=0,i=0,a=t.count;e<a;e++,i+=2)Gs.fromBufferAttribute(t,e),Ks.fromBufferAttribute(n,e),r[i]=i===0?0:r[i-1],r[i+1]=r[i]+Gs.distanceTo(Ks);let i=new ks(r,2,1);return e.setAttribute(`instanceDistanceStart`,new Co(i,1,0)),e.setAttribute(`instanceDistanceEnd`,new Co(i,1,1)),this}raycast(e,t){let n=this.material.worldUnits,r=e.camera;r===null&&!n&&console.error(`LineSegments2: "Raycaster.camera" needs to be set in order to raycast against LineSegments2 while worldUnits is set to false.`);let i=e.params.Line2===void 0?0:e.params.Line2.threshold||0;rc=e.ray;let a=this.matrixWorld,o=this.geometry,s=this.material;ic=s.linewidth+i,o.boundingSphere===null&&o.computeBoundingSphere(),tc.copy(o.boundingSphere).applyMatrix4(a);let c;if(c=n?ic*.5:ac(r,Math.max(r.near,tc.distanceToPoint(rc.origin)),s.resolution),tc.radius+=c,rc.intersectsSphere(tc)===!1)return;o.boundingBox===null&&o.computeBoundingBox(),ec.copy(o.boundingBox).applyMatrix4(a);let l;l=n?ic*.5:ac(r,Math.max(r.near,ec.distanceToPoint(rc.origin)),s.resolution),ec.expandByScalar(l),rc.intersectsBox(ec)!==!1&&(n?oc(this,t):sc(this,r,t))}},lc=class extends Us{constructor(){super(),this.isLineGeometry=!0,this.type=`LineGeometry`}setPositions(e){let t=e.length-3,n=new Float32Array(2*t);for(let r=0;r<t;r+=3)n[2*r]=e[r],n[2*r+1]=e[r+1],n[2*r+2]=e[r+2],n[2*r+3]=e[r+3],n[2*r+4]=e[r+4],n[2*r+5]=e[r+5];return super.setPositions(n),this}setColors(e){let t=e.length-3,n=new Float32Array(2*t);for(let r=0;r<t;r+=3)n[2*r]=e[r],n[2*r+1]=e[r+1],n[2*r+2]=e[r+2],n[2*r+3]=e[r+3],n[2*r+4]=e[r+4],n[2*r+5]=e[r+5];return super.setColors(n),this}fromLine(e){let t=e.geometry;return this.setPositions(t.attributes.position.array),this}},uc=class extends cc{constructor(e=new lc,t=new Ws({color:Math.random()*16777215})){super(e,t),this.isLine2=!0,this.type=`Line2`}},dc=Math.PI/180,fc={0:{name:`GPS`,color:2278750},1:{name:`SBAS`,color:9741240},2:{name:`Galileo`,color:16096779},3:{name:`BeiDou`,color:15680580},5:{name:`QZSS`,color:10980346},6:{name:`GLONASS`,color:3900150}},pc=0,mc=398600.4418,hc=18,gc={0:`G`,1:`S`,2:`E`,3:`C`,5:`J`,6:`R`},_c=1200,vc=120,yc=128,bc=4,xc=16777215,Sc=5,Cc=8;function wc(e){let t=new URLSearchParams(location.search).has(`demo`),r=t=>e.querySelector(t),i=r(`#globe-container`),a=r(`#status`),o=r(`#info`),s=r(`#legend`),c=r(`#sat-popup`),l=()=>({w:i.clientWidth||1,h:i.clientHeight||1}),{w:u,h:d}=l(),f=new vo({antialias:!0});f.setPixelRatio(window.devicePixelRatio),f.setSize(u,d),i.appendChild(f.domElement);let p=new bo;p.background=new Z(329743);let m=new ir(45,u/d,10,2e6);m.up.set(0,0,1),m.position.set(8e4,-78e3,52e3);let h=new Bs(m,f.domElement);h.enableDamping=!0,h.dampingFactor=.08,h.minDistance=8e3,h.maxDistance=6e5,h.autoRotateSpeed=.175,p.add(new hs(16777215,.35));let g=new ms(16777215,1.5);g.position.set(1,.5,.55).multiplyScalar(1e6),p.add(g),p.add(D());let _=null,v=0,y=new fo,b=new fo,x=new fo;p.add(y),p.add(b),p.add(x);let S=[],C=null,w=0,T={hours:24,trails:!1,rays:!0,orbits:!0,spin:!0,hidden:new Set};function E(e){_&&(p.remove(_),_.geometry.dispose());let t=new ss,r=t.load(`/static/img/earth_atmos_2048.jpg`);r.colorSpace=k,r.wrapS=n,r.offset.x=pc;let i=new Ho({map:r,specularMap:t.load(`/static/img/earth_specular_2048.jpg`),normalMap:t.load(`/static/img/earth_normal_2048.jpg`),shininess:14,specular:2245734});_=new Gn(new zo(e,96,64),i),_.rotation.x=Math.PI/2,p.add(_)}function D(){let e=1500,t=new Float32Array(e*3);for(let n=0;n<e;n++){let e=new X().randomDirection().multiplyScalar(9e5);t.set([e.x,e.y,e.z],n*3)}let n=new Dn;return n.setAttribute(`position`,new gn(t,3)),new Lo(n,new Mo({color:10466256,size:1200,sizeAttenuation:!0}))}function O(e){for(let t of[...e.children]){e.remove(t);let n=t;n.geometry&&n.geometry.dispose();let r=n.material;Array.isArray(r)?r.forEach(e=>e.dispose()):r&&r.dispose()}}function A(e,t,n=.7){return new Ao(new Dn().setFromPoints(e),new wo({color:t,transparent:!0,opacity:n}))}function j(){return f.getDrawingBufferSize(new q)}function M(e,t,n,r){let i=[];for(let t of e)i.push(t.x,t.y,t.z);let a=new lc().setPositions(i),o=j(),s=new Ws({color:t,linewidth:n,transparent:!0,opacity:r});s.resolution.set(o.x,o.y);let c=new uc(a,s);return c.frustumCulled=!1,c}function N(e){return Date.parse(e.t)/1e3}function ee(e,t=30){let n=Math.cos(t*dc),r=[],i=[];for(let t of e)i.length&&i[i.length-1].clone().normalize().dot(t.clone().normalize())<n&&(r.push(i),i=[]),i.push(t);return i.length&&r.push(i),r}function P(e,t){return t.clone().sub(e).dot(e.clone().normalize())>0}function F(e){I(e.earth_radius_km),O(y),O(b),S.length=0,me();let t=e.observer,n=new X(t.x,t.y,t.z);C=n,w=e.window&&e.window.end?Date.parse(e.window.end)/1e3:Date.now()/1e3,ue(n);let r=new Set,i=0;for(let t of e.sats){let e=fc[t.gnssid]||{name:`Other`,color:6583435};r.add(t.gnssid),i+=t.samples.length;let a=t.orbit,o=t.samples[t.samples.length-1],s=a?ie(a,w):new X(o.x,o.y,o.z);S.push({sat:t,pos:s});let c=new fo;if(c.userData.gnssid=t.gnssid,c.visible=!T.hidden.has(t.gnssid),T.orbits&&a&&c.add(ce(a,w,e.color,.22)),T.trails)if(a)c.add(A(oe(a,w,N(o)),e.color));else{let n=t.samples.map(e=>new X(e.x,e.y,e.z));for(let t of ee(n))t.length>=2&&c.add(A(t,e.color))}let l=o.snr||0,u=new Gn(new zo(180+Math.min(50,l)*9,12,10),new pn({color:e.color}));if(u.position.copy(s),c.add(u),T.rays&&P(n,s)){let t=new Dn().setFromPoints([n,s]);c.add(new Ao(t,new wo({color:e.color,transparent:!0,opacity:.18})))}y.add(c)}de(r),fe(e,i),V(``)}function I(e){e&&e!==v&&(v=e,E(e))}function te(e){return e/86400+2440587.5}function ne(e){let t=(te(e)-2451545)/36525;return((67310.54841+3164400184.812866*t+.093104*t*t-62e-7*t*t*t)%86400+86400)%86400*(2*Math.PI/86400)}function re(e,t,n,r){let i=Math.cos(r),a=Math.sin(r);return new X(e*i-t*a,e*a+t*i,n)}function L(e){return 2*Math.PI/e.n}function ie(e,t){let n=e.phase0+e.n*(t-e.epoch),r=Math.cos(n),i=Math.sin(n),a=e.radius_km;return re(a*(r*e.u[0]+i*e.v[0]),a*(r*e.u[1]+i*e.v[1]),a*(r*e.u[2]+i*e.v[2]),-ne(t))}function ae(e,t,n,r){let i=[];for(let a=0;a<=r;a++)i.push(ie(e,t+(n-t)*a/r));return i}function oe(e,t,n){let r=Math.min(Math.max(t-n,_c),L(e)),i=Math.min(yc,Math.max(2,Math.ceil(r/vc)));return ae(e,t-r,t,i)}function R(e){let t=e.clone().normalize(),n=Math.abs(t.z)<.9?new X(0,0,1):new X(1,0,0),r=new X().crossVectors(n,t).normalize();return{u:r,v:new X().crossVectors(t,r)}}function z(e,t){let{u:n,v:r}=R(e),i=[];for(let e=0;e<160;e++){let a=e/160*2*Math.PI;i.push(new X().addScaledVector(n,t*Math.cos(a)).addScaledVector(r,t*Math.sin(a)))}return i}function se(e,t,n,r){return new jo(new Dn().setFromPoints(z(e,t)),new wo({color:n,transparent:!0,opacity:r}))}function ce(e,t,n,r){return se(re(e.normal[0],e.normal[1],e.normal[2],-ne(t)),e.radius_km,n,r)}function le(e,t){let n=z(re(e.normal[0],e.normal[1],e.normal[2],-ne(t)),e.radius_km);return n.push(n[0].clone()),n}function ue(e){let t=new Gn(new zo(160,16,12),new pn({color:16777215}));t.position.copy(e),b.add(t);let n=e.clone().normalize().multiplyScalar(e.length()+2400),r=new Dn().setFromPoints([e,n]);b.add(new Ao(r,new wo({color:16777215,transparent:!0,opacity:.7})))}function de(e){s.innerHTML=[...e].sort((e,t)=>e-t).map(e=>{let t=fc[e]||{name:`Other`,color:6583435},n=`#`+t.color.toString(16).padStart(6,`0`);return`<button class="leg${T.hidden.has(e)?` off`:``}" data-gnss="${e}"><span class="sw" style="background:${n}"></span>${t.name}</button>`}).join(``),s.querySelectorAll(`.leg`).forEach(t=>{t.addEventListener(`click`,()=>{let n=Number(t.dataset.gnss);T.hidden.has(n)?T.hidden.delete(n):T.hidden.add(n),B(),de(e)})})}function B(){for(let e of y.children)e.visible=!T.hidden.has(e.userData.gnssid)}function fe(e,t){let n=e.observer,r=n.lat.toFixed(4),i=n.lon.toFixed(4),a=n.timestamp?new Date(n.timestamp).toLocaleString():`—`;o.innerHTML=`Observer <b>${r}°, ${i}°</b><br>Satellites <b>${e.sats.length}</b> · samples <b>${t.toLocaleString()}</b><br>Window <b>${T.hours}h</b> · anchored <b>${a}</b>`}function V(e){a.textContent=e,a.classList.toggle(`hide`,!e)}function H(e,t,n,r){let i=null,a=1/0;for(let o of S){if(T.hidden.has(o.sat.gnssid))continue;let s=o.pos.clone().project(m);if(s.z>1)continue;let c=(s.x*.5+.5)*n,l=(-s.y*.5+.5)*r;if(Math.hypot(c-e,l-t)>hc)continue;let u=o.pos.distanceTo(m.position);u<a&&(a=u,i={sat:o.sat,pos:o.pos,sx:c,sy:l})}return i}function U(e,t){return(gc[e]||`?`)+String(t).padStart(2,`0`)}function pe(e){return Math.sqrt(mc/e)}function W(e){if(!C)return null;let t=C.clone().normalize(),n=e.clone().sub(C).normalize(),r=Math.asin(be.clamp(t.dot(n),-1,1))/dc,i=new X().crossVectors(new X(0,0,1),t);i.lengthSq()<1e-9&&i.set(1,0,0),i.normalize();let a=new X().crossVectors(t,i),o=Math.atan2(n.dot(i),n.dot(a))/dc;return o<0&&(o+=360),{el:r,az:o}}function G(e,t,n,r){O(x);let a=fc[e.gnssid]||{name:`Other`,color:6583435},o=`#`+a.color.toString(16).padStart(6,`0`),s=t.length(),l=s-v,u=e.samples[e.samples.length-1],d=W(t),f=u.t?new Date(u.t).toLocaleTimeString():`—`,p=typeof u.snr==`number`&&u.snr>0?`${u.snr.toFixed(0)} dB-Hz${u.used?` · used`:``}`:`—`;if(c.innerHTML=`<div class="pop-head"><div class="pop-name"><span class="sw" style="background:${o}"></span>${U(e.gnssid,e.svid)}</div><button class="pop-close" aria-label="Close">×</button></div><div class="pop-row"><span>System</span><b>${a.name}</b></div><div class="pop-row"><span>Altitude</span><b>${Math.round(l).toLocaleString()} km</b></div><div class="pop-row"><span>Speed</span><b>${pe(s).toFixed(2)} km/s</b></div>`+(d?`<div class="pop-row"><span>Elevation</span><b>${d.el.toFixed(0)}°</b></div><div class="pop-row"><span>Azimuth</span><b>${d.az.toFixed(0)}°</b></div>`:``)+`<div class="pop-row"><span>Signal</span><b>${p}</b></div><div class="pop-row"><span>Observed</span><b>${e.samples.length} · ${f}</b></div>`,c.querySelector(`.pop-close`)?.addEventListener(`click`,me),c.style.left=Math.min(i.clientWidth-246,Math.max(8,n+14))+`px`,c.style.top=Math.min(i.clientHeight-210,Math.max(8,r+14))+`px`,c.classList.remove(`hidden`),e.orbit){let t=M(le(e.orbit,w),xc,bc,.5);t.userData.pulse={widthBase:bc,opacityBase:.5},x.add(t);let n=L(e.orbit),r=M(ae(e.orbit,w-n,w,256),a.color,Sc,.55);r.userData.pulse={widthBase:Sc,opacityBase:.55},x.add(r);let i=M(oe(e.orbit,w,N(u)),a.color,Cc,.7);i.userData.pulse={widthBase:Cc,opacityBase:.7},x.add(i)}let m=new Gn(new zo(620,16,12),new pn({color:16777215,wireframe:!0,transparent:!0,opacity:.55}));m.position.copy(t),x.add(m)}function me(){c.classList.add(`hidden`),O(x)}async function he(){V(`Loading constellation…`);try{let e=t?_e():await ge(T.hours);if(!e.sats.length&&!t){V(`No satellite observations in this window yet.`),O(y),O(b);return}F(e)}catch(e){V(typeof e==`string`?e:`Could not load constellation data.`)}}async function ge(e){let t=new Date,n=`start=${new Date(t.getTime()-e*3600*1e3).toISOString()}&end=${t.toISOString()}`,r=await fetch(`/api/constellation?${n}`);if(!r.ok)throw(await r.json().catch(()=>({}))).error||`No GPS fix available to anchor the observer.`;return r.json()}function _e(){let e=6371,t=ve(39.74,-104.99,e),n=Date.now()/1e3,r=[[0,26560,8],[6,25510,6],[2,29600,6],[3,27910,5]],i=[],a=1;for(let[e,t,o]of r){let r=Math.sqrt(mc/t**3);for(let s=0;s<o;s++){let o=ye((50+Math.random()*12)*dc,Math.random()*2*Math.PI),{u:s,v:c}=R(o),l={epoch:n,radius_km:t,n:r,phase0:Math.random()*2*Math.PI,u:[s.x,s.y,s.z],v:[c.x,c.y,c.z],normal:[o.x,o.y,o.z]},u=[];for(let e=0;e<8;e++){let t=n-3600+e*450,r=ie(l,t);u.push({t:new Date(t*1e3).toISOString(),x:r.x,y:r.y,z:r.z,snr:18+Math.random()*28,used:Math.random()>.4})}i.push({gnssid:e,svid:a++,samples:u,orbit:l})}}return{observer:{lat:39.74,lon:-104.99,alt:1600,x:t.x,y:t.y,z:t.z,timestamp:new Date().toISOString()},earth_radius_km:e,window:{end:new Date(n*1e3).toISOString()},sats:i}}function ve(e,t,n){let r=e*dc,i=t*dc;return new X(n*Math.cos(r)*Math.cos(i),n*Math.cos(r)*Math.sin(i),n*Math.sin(r))}function ye(e,t){return new X(Math.sin(t)*Math.sin(e),-Math.cos(t)*Math.sin(e),Math.cos(e))}function K(){e.querySelectorAll(`#windows .chip`).forEach(t=>{t.addEventListener(`click`,()=>{e.querySelectorAll(`#windows .chip`).forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),T.hours=Number(t.dataset.h),he()})}),J(`t-orbits`,`orbits`,()=>he()),J(`t-trails`,`trails`,()=>he()),J(`t-rays`,`rays`,()=>he()),J(`t-spin`,`spin`,()=>{h.autoRotate=T.spin}),h.autoRotate=T.spin}function J(e,t,n){let i=r(`#`+e);i.classList.toggle(`active`,T[t]),i.addEventListener(`click`,()=>{T[t]=!T[t],i.classList.toggle(`active`,T[t]),n()})}function xe(e){e.key===`Escape`&&me()}function Se(e){we=e.clientX,Te=e.clientY,Ee=performance.now()}function Ce(e){if(Math.hypot(e.clientX-we,e.clientY-Te)>6||performance.now()-Ee>500)return;let t=f.domElement.getBoundingClientRect(),n=H(e.clientX-t.left,e.clientY-t.top,t.width,t.height);n?G(n.sat,n.pos,n.sx,n.sy):me()}let we=0,Te=0,Ee=0;function De(){let e=l();u=e.w,d=e.h,m.aspect=u/d,m.updateProjectionMatrix(),f.setSize(u,d)}function Oe(e){if(!x.children.length)return;let t=j(),n=.5+.5*Math.sin(e*2.4);for(let e of x.children){let r=e.material;if(!r||!r.resolution)continue;r.resolution.set(t.x,t.y);let i=e.userData.pulse;i&&(r.linewidth=i.widthBase*(1+.5*n),r.opacity=i.opacityBase+.35*n)}}let ke=0;function Ae(){ke=requestAnimationFrame(Ae),h.update(),Oe(performance.now()/1e3),f.render(p,m)}let Y=new ResizeObserver(De);return Y.observe(i),window.addEventListener(`keydown`,xe),f.domElement.addEventListener(`pointerdown`,Se),f.domElement.addEventListener(`pointerup`,Ce),K(),E(6371),he(),Ae(),()=>{cancelAnimationFrame(ke),Y.disconnect(),window.removeEventListener(`keydown`,xe),h.dispose(),O(y),O(b),O(x),_&&(_.geometry.dispose(),_.material.dispose()),p.traverse(e=>{let t=e;t.geometry&&t.geometry.dispose();let n=t.material;Array.isArray(n)?n.forEach(e=>e.dispose()):n&&n.dispose()}),f.dispose(),f.forceContextLoss(),f.domElement.remove()}}export{wc as mountGlobe};